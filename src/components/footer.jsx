...
const Footer = () => {
  return (
    <>
      <div className='bg-[#191919] h-[428px]'>
        <div className='mx-12'>
          <div className='mx-24 pt-16'>
            <div className='flex gap-12 items-center'>
              <div className='flex-col w-[300px] text-[#FFFFFF] me-20'>
                <img src={Logo} className='w-[139px] h-[86.22px] mb-6' alt='' />
                <p className='mb-6'>Sebuah aplikasi yang memudahkan semua orang untuk berbelanja kebutuhan sehari hari dengan cepat dan mudah</p>
        ...
        <hr className='border-[#b3b3b3] mt-12' />
        <div className='mx-24 p-5 text-white text-[14px] font-regular'>For Eat eCommerce © 2023 All Rights Reserved</div>
      </div>
    </>
  );
};
