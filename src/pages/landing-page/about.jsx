      ...
      <div className="HomePage w-screen h-96 left-0 top-[68px] absolute bg-white">
        ...
        <div className="Info left-[806px] top-[30px] absolute flex-col justify-start items-start gap-6 inline-flex">
          ...
          <div className="Feature flex-col justify-start items-start gap-2.5 flex">
            ...
            <div className="Description pl-8 justify-start items-start inline-flex">
              <div className="ApakahAndaMencariSumberTerpercayaUntukMemenuhiKebutuhanSayuranSegarDanProdukBerkualitasSetiapHariForeatAdalahSolusiTerbaikUntukKebutuhanMakananAndaYangSehatDanBergizi w-96 text-black text-sm font-light font-['Poppins'] leading-tight">Apakah Anda mencari sumber terpercaya untuk memenuhi kebutuhan sayuran segar dan produk berkualitas setiap hari? ForEat adalah solusi terbaik untuk kebutuhan makanan Anda yang sehat dan bergizi.</div>
            </div>
          </div>
        </div>
        ...
        <div className="Info h-24 left-[413px] top-[215px] absolute flex-col justify-start items-start gap-6 inline-flex">
          <div className="Frame216 flex-col justify-start items-start gap-3 flex">
            <div className="Frame217 flex-col justify-start items-start gap-2 flex">
              <div className="DiskonHingga w-36 text-zinc-900 text-sm font-medium font-['Poppins'] uppercase leading-none tracking-wide">diskon hingga</div>
              <div className=" w-24 text-center text-zinc-900 text-3xl font-semibold font-['Poppins'] leading-10">75%  </div>
            </div>
            <div className="HanyaSayurBuah text-lime-700 text-sm font-normal font-['Poppins'] leading-tight">Hanya  Sayur & Buah</div>
          </div>
        </div>
      </div>
      <div className="Button px-10 py-4 left-[800px] top-[493px] absolute bg-green-600 rounded-3xl justify-center items-center gap-4 inline-flex">
        <div className="ShopNow text-white text-base font-semibold font-['Poppins'] leading-tight">Belanja Sekarang</div>
      ...
      <div className="MacbookPro141 w-[200vh] h-[110vh] left-0 top-[2796px] absolute bg-gradient-to-bl from-emerald-700 via-teal-100 to-emerald-700 shadow">
        ...
        <div className="AboutMe w-96 h-96 left-[698px] top-[218px] absolute">
          ...
          <div className="Feature w-80 h-16 left-0 top-[145px] absolute bg-white justify-start items-center gap-4 inline-flex">
            ...
            <div className="Info flex-col justify-center items-start gap-2 inline-flex">
              ...
              <div className="SehatSegar w-56 text-zinc-500 text-sm font-normal font-['Poppins'] leading-tight">100% Sehat & Segar</div>
            </div>
          </div>
          <div className="Feature w-80 h-16 left-0 top-[241px] absolute bg-white justify-start items-center gap-4 inline-flex">
            ...
            <div className="Info flex-col justify-center items-start gap-2 inline-flex">
              <div className="PelayanTerbaik w-56 text-zinc-900 text-lg font-medium font-['Poppins'] leading-relaxed">Pelayan Terbaik</div>
              <div className="MembuatPelangganBahagia w-56 text-neutral-400 text-sm font-normal font-['Poppins'] leading-tight">Membuat Pelanggan Bahagia</div>
            </div>
          </div>
          <div className="Feature w-80 h-16 left-0 top-[337px] absolute bg-white justify-start items-center gap-4 inline-flex">
            ...
            <div className="Info flex-col justify-center items-start gap-2 inline-flex">
              ...
              <div className="BebasOngkirDiskon w-56 text-neutral-400 text-sm font-normal font-['Poppins'] leading-tight">Bebas Ongkir & Diskon</div>
            </div>
          </div>
          <div className="Feature w-80 h-16 left-[336px] top-[146px] absolute bg-white justify-start items-center gap-4 inline-flex">
            ...
            <div className="Info flex-col justify-center items-start gap-2 inline-flex">
             ...
             <div className="AksesCepatKeKontak w-56 text-neutral-400 text-sm font-normal font-['Poppins'] leading-tight">Akses cepat ke Kontak</div>
            </div>
          </div>
          <div className="Feature w-80 h-16 left-[336px] top-[242px] absolute bg-white justify-start items-center gap-4 inline-flex">
            ...
            <div className="Info flex-col justify-center items-start gap-2 inline-flex">
              <div className="PemayarannyaAman w-56 text-zinc-900 text-lg font-medium font-['Poppins'] leading-relaxed">100% Pemayarannya Aman</div>
            </div>
          </div>
          <div className="Feature w-80 h-16 left-[336px] top-[338px] absolute bg-white justify-start items-center gap-4 inline-flex">
            ...
            <div className="Info flex-col justify-center items-start gap-2 inline-flex">
              ...
              <div className="Mantap w-56 text-neutral-400 text-sm font-normal font-['Poppins'] leading-tight">100% Mantap</div>
            </div>
          </div>
        </div>
        ...
        <div className="Group79 w-96 h-96 left-0 top-[777px] absolute">
          ...
          <div className="Frame142 w-72 h-8 left-[998px] top-[373px] absolute justify-start items-start gap-2 inline-flex">
            ...
            <div className="MethodMastercard w-11 h-8 relative">
              ...
              <div className="Mastercard w-7 h-4 left-[7.94px] top-[6.66px] absolute">
                ...
                <img className="Right w-3.5 h-4 left-[14.80px] top-[-0px] absolute" src="https://via.placeholder.com/15x18" />
          ...
          <div className="MyAccount w-28 h-10 left-[642px] top-[121px] absolute flex-col justify-start items-start gap-3 inline-flex">
            <div className="KontakKami text-white text-lg font-medium font-['Poppins'] leading-relaxed">Kontak Kami</div>
          </div>
          ...
          <div className="Company w-72 h-64 left-[173px] top-[69.50px] absolute flex-col justify-start items-start gap-4 inline-flex">
            ...
            <div className="SocialMedia justify-start items-start gap-2 inline-flex">
              <div className="SocialMedia w-10 h-10 relative">
                <div className="Ellipse3 w-10 h-10 left-0 top-0 absolute bg-green-600 rounded-full" />
                <div className="Facebook1 w-4 h-4 left-[11px] top-[11px] absolute" />
              </div>
              <div className="SocialMedia w-10 h-10 relative rounded-full">
