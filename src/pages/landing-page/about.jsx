    ...
    <>
      ...
      <div className='about bg-gray-300'>
        <div className='Homepage flex justify-center'>
          <div className='Rectangle1 flex items-center gap-6 mt-[20vh]'>
            ...
            <div className='diskon bang'>
              <div className='Rectang2 w-44 h-32 left-[400px] bottom-[300px] absolute bg-gradient-to-b from-zinc-300 '></div>
              <div className='Rectangle3 w-40 h-32 left-[400px] bottom-[300px] absolute bg-gradient-to-b from-zinc-300 backdrop-blur-sm'>
        ...
        <div className='ijo godong mt-20'>
          <div className='backijo min-h-screen '>
          ...
          <div className='rectangle bg-white min-h-screen '>
            <div className='flex justify-center items-center'>
              <div className=' flex mt-[100px] gap-32 text-black'>
                <div className='grid mt-5'>
                  <img src={cara1} className='mb-8' />
            ...
            <div className='rectagle bg-[#7EB685] flex justify-center items-center w-[80vw] top-[270vh] left-[10vw] absolute rounded-md p-4 '>
              <div className='cara text-black flex justify-center items-center text-3xl font-bold '>Cara Berbelanja di ForEat</div>
            </div>
          </div>
          <div className='rectangle bg-[#94AF9F] min-h-screen pb-8'>
            <div className='flex ml-[120px] gap-28'>
              ...
              <div>
                ...
                <p className=' mt-7 w-[40vw] text-black'>
                  Apakah jadwal padat Anda membuat sulit untuk memperoleh sayuran segar dan bahan memasak berkualitas? Kami dari ForEat hadir untuk memberikan soluis! dengan platform daring kami,
                  belanja sayuran segar dan bahan memasak berkualitas tinggi menjadi lebih mudah dari sebelumnya.
                </p>
                <div className=' grid grid-cols-2 mt-5 mr-[200px] gap-6 rounded-lg'>
                  <div className='rectangle flex bg-white h-[90px]'>
