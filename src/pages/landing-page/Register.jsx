...
const Register = () => {
  return (
    <>
      <div className='backgorund1 bg-white min-h-screen py-8'>
        <div>
          <div className='pt-5'>
          ...
          <div className='flex flex-col mt-6 justify-center items-center'>
            ...
            <div className='text-sm mt-7 mr-30 w-[370px] gap-2'>
              <p>
                Dengan melanjutkan, Anda menyetujui <span className='text-[#498528] font-bold'>persyaratan layanan kami</span>
              </p>
            </div>
            <Link to='/login'>
            ...
            <button class='flex w-[400px] mt-7 items-center bg-[#D9D9D9] text-[#4B5768] p-3 gap-3 rounded-[4px] hover:bg-[#498528] focus:outline-none focus:shadow-outline-blue' type='submit'>
              <img src={Google} className='ml-[60px]' />
